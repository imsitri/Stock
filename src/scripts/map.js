...
var myimage = svg
	.append("svg:image")
	.attr("xlink:href", "../src/assets/image.jpg")
	.style("display", "block")
	.attr("x", 300);
...
function createGraph(id) {
	document.getElementById("map-interactive").innerHTML = ""
	...
	switch (id) {
		case 1:
			file_url =
				"../src/assets/Suspnd_sedmnt_disch.Suspended_Sediment_Discharge.COMP@330131114364101.20211001 (2).csv";
			break;
		case 2:
			file_url =
				"../src/assets/Suspnd_sedmnt_disch.Suspended_Sediment_Discharge.COMP@09429500.20211001 (1).csv";
			break;
		case 3:
			file_url =
				"../src/assets/Suspnd_sedmnt_disch.Suspended_Sediment_Discharge.COMP@09522990.20211001 (1).csv";
			break;
		case 4:
			file_url =
				"../src/assets/Suspnd_sedmnt_disch.Instantaneous_Suspended_Sediment_Load_in_short_tons_per_day_ss_discharge@09429497.20211001 (1).csv";
			break;
		case 5:
			file_url = "../src/assets/NTDOY.csv";
			break;
		default:
			file_url = "../src/assets/NTDOY.csv";
			break;
